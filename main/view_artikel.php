	...
	<h1>Home</h1>
			...
			<?php
				...
				while($row = mysql_fetch_array($query)){
					echo "<td><a class='btn btn-primary' href='view_artikel.php?id=".$row['id']."'>".$row['kamus']."</a></td>";
					}
				echo "</tr>";
			?>
			</table>
		...
		while($rok = mysql_fetch_array($query1)){
			echo "<tr><td><h2>".$rok['judul_artikel']."</h2><p>".$rok['artikel_sumber']."</p><br />".$rok['date_time']."</td></tr>";
			}
	?>
		</table>
